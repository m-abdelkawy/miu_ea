...
public class Car {
    ...
    private Company carManufacturer;
    ...
    public Car(String model, int mileage, int year, Company carManufacturer) {
        this.model = model;
    ...
    public Car(String model, int mileage, int year, Company carManufacturer, Company insuranceCompany) {
        this.model = model;
        this.mileage = mileage;
        this.year = year;
        this.carManufacturer = carManufacturer;
